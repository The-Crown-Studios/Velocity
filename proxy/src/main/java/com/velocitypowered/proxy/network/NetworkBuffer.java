...
public final class NetworkBuffer {
    ...
    public static final Type<org.jglrxavpok.hephaistos.nbt.NBT> NBT = NetworkBufferTypes.NBT;
    public static final Type<Component> COMPONENT = NetworkBufferTypes.COMPONENT;
    public static final Type<java.util.UUID> UUID = NetworkBufferTypes.UUID;
    ...
    public static final Type<java.util.UUID> OPT_UUID = NetworkBufferTypes.OPT_UUID;

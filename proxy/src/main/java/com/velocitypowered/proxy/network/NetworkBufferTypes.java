...
final class NetworkBufferTypes {
    ...
    static final TypeImpl<org.jglrxavpok.hephaistos.nbt.NBT> NBT = new TypeImpl<>(org.jglrxavpok.hephaistos.nbt.NBT.class,
            (buffer, value) -> {
    ...
    static final TypeImpl<java.util.UUID> UUID = new TypeImpl<>(java.util.UUID.class,
            (buffer, value) -> {
    ...
    static final TypeImpl<java.util.UUID> OPT_UUID = new TypeImpl<>(java.util.UUID.class,
            (buffer, value) -> {
                if (value == null) {
                    buffer.write(BOOLEAN, false);
                    return -1;

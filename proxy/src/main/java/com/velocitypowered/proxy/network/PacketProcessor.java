...
import com.velocitypowered.proxy.network.packet.client.ClientPacketsHandler;
 ...
 */
public record PacketProcessor(
        @NotNull ClientPacketsHandler statusHandler,
    ...
    public ClientPacket process(@NotNull ClientConnection connection, int packetId, ByteBuffer body) {

 ...
 */
public final class VelocityAdventure {
    ...
    public static void setDefaultLocale(@Nullable Locale defaultLocale) {
        VelocityAdventure.defaultLocale = Objects.requireNonNullElseGet(defaultLocale, Locale::getDefault);
    }

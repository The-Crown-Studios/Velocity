...
public class AdventurePacketConvertor {
     ...
     */
    public static @NotNull ProxyPacket createSoundPacket(@NotNull Sound sound, double x, double y, double z) {
     ...
     * @return the sound packet
     */
    public static @NotNull ProxyPacket createSoundPacket(@NotNull Sound sound, Sound.@NotNull Emitter emitter) {
    ...
    public static ProxyPacket createEntitySoundPacket(@NotNull Sound sound, @NotNull Entity entity) {
